...
class SimpleChatBot extends JFrame implements ActionListener {
    ...
    final String TITLE_OF_PROGRAM = "Usama:    chatbot";
    final int START_LOCATION = 200;
    final int WINDOW_WIDTH = 388;
    final int WINDOW_HEIGHT = 488;
    ...
    SimpleChatBot() {
        ...
        StyleConstants.setForeground(botStyle, Color.darkGray);
